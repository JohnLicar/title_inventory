                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div>
                            <x-inputs.group :error="$errors->first('middle_name')">
                                ...
                                <x-inputs.label>Middle Name <span class="text-xm"> (optional)</span></x-inputs.label>
                            </x-inputs.group>
                        </div>

                        <div>
                            <x-inputs.group :error="$errors->first('birthday')">
                                <x-date-picker name='birthday' wire:model='birthday' :value="'Birthday'" />
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div>
                            <x-inputs.group :error="$errors->first('spouse_birthday')">
                                ...
                                <x-inputs.label>Spouse Birth Day</x-inputs.label>
                            </x-inputs.group>
                        </div>
